    ...
    function getDATA() {
       ...
       $.each(data,function(key1,item1){
        ...
        $.each(data,function(key1,item1){
              ...
              // console.log(itemData2); 	
                $.each(itemData2,function(key3,item3){  
                   ...
                   if (key3 === '11') {
                       if (item3> 0) 
                           {
                              $("#item-72").addClass("risePrice"); 
                              $("#item-73").addClass("risePrice"); 
                            // $("#item-13").html("???" +???item3); 	
                           } 
                       else {
                          if (item3 === 0){ 
                            $("#item-72").addClass("flatPrice"); 
                            $("#item-73").addClass("flatPrice"); 		
                          }
                          else {
                            $("#item-72").addClass("fellPrice"); 
                            $("#item-73").addClass("fellPrice"); 	
                          }
                       }
                       $("#item-73").html(item3); 
                   } 
         ...
         //  console.log(item1[0]);
             if ($("#item-74").html() >= $("#item-72").html() - $("#item-73").html())
             {
                 $("#item-74").addClass("highestPrice");
             }  
             else {
                 $("#item-74").addClass("lowestPrice");
             }
             if ($("#item-75").html() >= $("#item-72").html() - $("#item-73").html())
             {
                 $("#item-75").addClass("highestPrice");
             }  
             else {
                 $("#item-75").addClass("lowestPrice");
             }                  
        }
       });
      });   
        ...
        // *** 7th stock End ***
        // *** 8th stock start ***
        $.getJSON('https://ws.api.cnyes.com/ws/api/v1/charting/history?resolution=1&symbol=TWS:8150:STOCK&quote=1',function(data){
          // console.log('success');
        $.each(data,function(key1,item1){
           if (key1 === 'data') {
           //  $('ul').append('<li>'+item1+'</li>');
              ...
              // console.log(itemData2); 	
                $.each(itemData2,function(key3,item3){  
                   ...
                   if (key3 === '11') {
                       if (item3> 0) 
                           {
                              $("#item-82").addClass("risePrice"); 
                              $("#item-83").addClass("risePrice"); 
                            // $("#item-13").html("???" +???item3); 	
                           } 
                       else {
                          if (item3 === 0){ 
                             $("#item-82").addClass("flatPrice"); 
                            $("#item-83").addClass("flatPrice"); 		
                          }
                          else {
                             $("#item-82").addClass("fellPrice"); 
                            $("#item-83").addClass("fellPrice"); 	
                          }
                       }
                       $("#item-83").html(item3); 
                   } 
         ...
         //  console.log(item1[0]);
             if ($("#item-84").html() >= $("#item-82").html() - $("#item-83").html())
             {
                 $("#item-84").addClass("highestPrice");
             }  
             else {
                 $("#item-84").addClass("lowestPrice");
             }
             if ($("#item-85").html() >= $("#item-82").html() - $("#item-83").html())
             {
                 $("#item-85").addClass("highestPrice");
             }  
             else {
                 $("#item-85").addClass("lowestPrice");
             }                  
        }
       });
      });   
